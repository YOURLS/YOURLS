...
class Translation_Domain_Tests extends PHPUnit\Framework\TestCase {
    ...
    public function test_custom_fake_domain() {
        ...
        $this->expectExceptionMessageRegExp('/Cannot read file [0-9a-z]+\/[0-9a-z]+-fr_FR\.mo\. Make sure there is a language file installed. More info: http:\/\/yourls\.org\/translations/');
