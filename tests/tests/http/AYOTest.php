...
#[\PHPUnit\Framework\Attributes\Group('AYO')]
class AYOTest extends PHPUnit\Framework\TestCase {
     ...
     */
    public static function return_case_object( $failed_attempts, $last_attempt, $version_checked ) {
        $checks = new stdClass();
    ...
    public static function case_scenario() {
         ...
         */
        $name = 'Case 1';
        $checks = self::return_case_object(
     ...
     * @since 0.1
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('case_scenario')]
     ...
     * @since 0.1
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('json_responses')]
     ...
     */
    public static function fake_and_true_github_repo_urls() {
        $return = array();
     ...
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('fake_and_true_github_repo_urls')]
     ...
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('new_version_scenarios')]
     ...
     */
    static function various_zipball_url_version() {
        $return = [];
     ...
     * Test various zipball URLs and get version number from it
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('various_zipball_url_version')]
     ...
     */
    static function get_various_json_response_keys() {
        $return = [];
     ...
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('get_various_json_response_keys')]
