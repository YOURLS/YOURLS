...
class Markdown {
	...
	protected function _doHeaders_callback_setext($matches) {
		...
		$block = "<h$level id=\"".stringToHtmlID($this->runSpanGamut($matches[1]))."\">".$this->runSpanGamut($matches[1])."</h$level>";
		return "\n" . $this->hashBlock($block) . "\n\n";
	}
	protected function _doHeaders_callback_atx($matches) {
		$level = strlen($matches[1]);
		$block = "<h$level id=\"".stringToHtmlID($this->runSpanGamut($matches[2]))."\">".$this->runSpanGamut($matches[2])."</h$level>";
		return "\n" . $this->hashBlock($block) . "\n\n";
	}
