...
?>
	...
	$('#toggle_plugins').css({'background':'transparent url("../assets/img/filter.gif") top left no-repeat','display':'inline-block','text-indent':'-9999px','width':'16px','height':'16px','margin-left':'3px','cursor':'pointer'})
